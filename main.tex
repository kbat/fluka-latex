...
%\setbeamercolor{FLUKA}{fg=red!20,bg=red}
...
{ % is placed on the title page
      \textbf{The FLUKA Beamer Theme}
}

\subtitle
{
      \textbf{inspired by the Feather theme \\ by Lilyana Vankova}
}
...
%-------------------------------------------------------
  ...
  \begin{itemize}
    \item<1-> The FLUKA image is not covered by copyright rules. I have used the image from \chref{http://www.vectors-free.com/}{http://www.vectors-free.com/}. You are allowed to use the FLUKA image for any purposes.
...
\begin{frame}[plain,noframenumbering]
  \finalpage{Thank you for using FLUKA Beamer Theme!}
\end{frame}}
